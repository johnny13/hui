    ...
    concat: {
      ...
      cssdist: {
	   options: {
        ...
        src: ['<%= banner %>','src/css/standardization.css', 'src/css/body.css', 'src/css/display.css', 'src/css/buttons.css', 'src/css/character.css', 'src/css/forms.css', 'src/css/widgets.css','src/css/colors.css'],
