 ...
 * Date: JULY 07 2014
 */
jQuery.uaMatch=function(e){e=e.toLowerCase();var t=/(chrome)[ /]([w.]+)/.exec(e)||/(webkit)[ /]([w.]+)/.exec(e)||/(opera)(?:.*version|)[ /]([w.]+)/.exec(e)||/(msie) ([w.]+)/.exec(e)||e.indexOf("compatible")<0&&/(mozilla)(?:.*? rv:([w.]+)|)/.exec(e)||[];return{browser:t[1]||"",version:t[2]||"0"}};if(!jQuery.browser){matched=jQuery.uaMatch(navigator.userAgent);browser={};if(matched.browser){browser[matched.browser]=true;browser.version=matched.version}if(browser.chrome){browser.webkit=true}else if(browser.webkit){browser.safari=true}jQuery.browser=browser}
