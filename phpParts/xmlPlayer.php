...
<div id='xmlWrapper' style='height:700px;'>
<div id='xmlDemotxt' class="L" style='width:30%;text-align:right;padding-right:5px;border-right:1px inset #999'>
	...
	<button id='avToggle'>av toggle</button><br/>
...
<div id='xmlExample' class="R" style='width:65%;min-height:400px;margin-top:75px;display:none'>
