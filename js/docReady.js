...
$('form').jqTransform({imgPath:'css/Spectyle/'});
...
//Example Audio Visual Toggle Button for xmlPlayer
$('#avToggle').click(function() {	
...
var randNum = Math.random() * 80;
// Progressbar
$(".theme_bar").progressbar({
	value: randNum
}).width(90);
